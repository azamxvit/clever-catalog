// app/[locale]/ceramogranit/page.tsx
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const t = await getTranslations("catalog.ceramogranit.meta");
  return { title: t("title"), description: t("description") };
}

export default async function CeramogranitPage() {
  const t = await getTranslations("catalog.ceramogranit");
  ...
  return (
    <div className="pt-20 pb-16 bg-[#f8f5f0] min-h-screen">
      <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <CatalogLayout defaultCategory="porcelain" />
